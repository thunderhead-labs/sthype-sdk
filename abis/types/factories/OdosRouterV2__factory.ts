...
import type { OdosRouterV2, OdosRouterV2Interface } from "../OdosRouterV2";
...
export class OdosRouterV2__factory {
  static readonly abi = _abi;
  static createInterface(): OdosRouterV2Interface {
    return new utils.Interface(_abi) as OdosRouterV2Interface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): OdosRouterV2 {
    return new Contract(address, _abi, signerOrProvider) as OdosRouterV2;
  }
}
